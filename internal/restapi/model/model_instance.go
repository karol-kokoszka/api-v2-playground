...
// Instance - Cloud provider instance pricing description
type Instance struct {

	// ID of the instance type (internal for scylla-cloud)
	Id int32 `json:"id,omitempty"`

	// External ID of the cloud provider instance type
	ExternalId string `json:"externalId,omitempty"`

	// ID of the cloud provider (full list [get] /deployment/provider)
	CloudProviderId int32 `json:"cloudProviderId,omitempty"`

	// GroupDefault says which one is the default in a group of matching external_id
	GroupDefault bool `json:"groupDefault,omitempty"`

	// Position when showing multiple instance types
	DisplayOrder int32 `json:"displayOrder,omitempty"`

	// Instance type RAM size in Megabytes
	Memory int32 `json:"memory,omitempty"`

	// Instance type disk count
	LocalDiskCount int32 `json:"localDiskCount,omitempty"`

	// Instance type total memory size (uses base of 10 GB)
	TotalStorage int32 `json:"totalStorage,omitempty"`

	// Instance type CPU core count
	CpuCount int32 `json:"cpuCount,omitempty"`

	// Instance type network bandwidth in Megabytes per second
	NetworkSpeed int32 `json:"networkSpeed,omitempty"`

	// Cloud provider storage bandwidth in Megabytes per second
	ExternalStorageNetworkSpeed int32 `json:"externalStorageNetworkSpeed,omitempty"`

	// Deprecated in favor of InstanceCostHourly
	CostPerHour float32 `json:"costPerHour,omitempty"`

	// Development clusters lack advanced features (e.g. Scylla Manager, monitoring alerts and many others) which are present in Production clusters
	Environment string `json:"environment,omitempty"`

	// Deprecated
	LicenseCostOnDemandPerHour float32 `json:"licenseCostOnDemandPerHour,omitempty"`

	// Scylla related part of the cost
	SubscriptionCostHourly float32 `json:"subscriptionCostHourly,omitempty"`

	// Cloud provider related part of the cost
	InstanceCostHourly float32 `json:"instanceCostHourly,omitempty"`

	// The amount of hours for which instance type is eligible for free tier
	FreeTierHours int32 `json:"freeTierHours,omitempty"`
}
