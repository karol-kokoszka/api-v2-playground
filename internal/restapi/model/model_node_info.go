...
type NodeInfo struct {
	...
	// Date when server joined the cluster
	ClusterJoinDate string `json:"clusterJoinDate,omitempty"`
	...
	// Deprecated
	ServiceVersionId int32 `json:"serviceVersionId,omitempty"`
