...
type ClusterCreateRequestV1 struct {

	// ID of the account credentials
	AccountCredentialId int32 `json:"accountCredentialId,omitempty"`

	// Write isolation for ALTERNATOR
	...
	// ID of the cloud provider region (full list [get] /deployment/provider/{}/region)
	RegionId int32 `json:"regionId,omitempty"`

	// Enables DNS on the cluster and creation of the DNS records for the seed nodes at cluster creation time
	EnableDNSAssociation bool `json:"enableDNSAssociation,omitempty"`

	// List of CIDR formatted rules a.b.c.d/e
	AllowedIPs []FirewallRule `json:"allowedIPs,omitempty"`

	// Defines if the free-tier cluster should be created
	...
	// Defines if prometheus proxy will be available
	PromProxy bool `json:"promProxy,omitempty"`

	// Replication Factor (RF)
	ReplicationFactor int32 `json:"replicationFactor,omitempty"`

	// Version of Scylla
	ScyllaVersionId int32 `json:"scyllaVersionId,omitempty"`
