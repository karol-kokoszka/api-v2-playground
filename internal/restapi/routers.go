...
var routes = Routes{
	...
	{
		"GetFirewallAllowedRules",
		http.MethodGet,
		"/account/:accountId/cluster/:clusterId/network/firewall/allowed",
		api.GetFirewallAllowedRules,
	},
	...
	{
		"GetClusterRequestById",
		http.MethodGet,
		"/account/:accountId/cluster/request/:requestId",
		api.GetClusterRequestById,
	},
